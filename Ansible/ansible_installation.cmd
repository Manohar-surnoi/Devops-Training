...
Now we need to check Ansible and Node connection using (ssh public ip of Node), Then we will create a Directory or file in Ansible server and same time it will reflect in Node
We need to create an Inventory in ansible server using (vi inventory.ini), in Inventory we need to give Node Private ip
